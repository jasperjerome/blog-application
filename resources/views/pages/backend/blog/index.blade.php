        ...
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <a href="{{ route('blog.create') }}" type="button" class="btn btn-success waves-effect waves-light">Add
                        New</a>
                </div>
                            ...
                            <tbody>
                                @foreach ($data as $index => $datas)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('blog.edit', ['id' => $datas->id]) }}"
                                                class="btn btn-warning waves-effect waves-light">
                                                <i class="bx bx-pencil font-size-16 align-middle"></i>
                                            </a>
                                            <a href="#deleteProduct{{ $datas->id }}" data-bs-toggle="modal"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p class="text-muted font-size-16 mb-4">Are you sure you want to delete
                                                        this Blog permanently</p>
                                                </div>
                                                <div class="modal-footer">
                                                    <form autocomplete="off" method="POST"
                                                        action="{{ route('blog.delete', ['id' => $datas->id]) }}">
                                                        @method('DELETE')
                                                        @csrf
